...
df = read.csv('../papers/analysis/GPT-4_base_embed/summary/summarize_agreement.csv')
styledDT(df)
```
...
df = read.csv('../papers/analysis/GPT-4_base_embed/summary/summarize_agree_detail.csv')
df = df %>% select(1, 2)
styledDT(df)
```
...
df = read.csv('../papers/analysis/GPT-4_base_embed/summary/summarize_by_question.csv', check.names = FALSE)
...
```{r base-bool}
df = read.csv('../papers/analysis/GPT-4_base_embed/summary/gpt-4_base.compare.bool.csv', check.names = FALSE)
df2 = read.csv('../papers/analysis/GPT-4_base_embed/summary/gpt-4_embed.compare.bool.csv', check.names = FALSE)
...
```{r base-num}
df = read.csv('../papers/analysis/GPT-4_base_embed/summary/gpt-4_base.compare.num.csv', check.names = FALSE)
df2 = read.csv('../papers/analysis/GPT-4_base_embed/summary/gpt-4_embed.compare.num.csv', check.names = FALSE)
...
```{r base-cat}
df = read.csv('../papers/analysis/GPT-4_base_embed/summary/gpt-4_base.compare.cat.csv', check.names = FALSE)
df2 = read.csv('../papers/analysis/GPT-4_base_embed/summary/gpt-4_embed.compare.cat.csv', check.names = FALSE)
...
df = read.csv('../papers/analysis/GPT-4_base_embed/summary/summarize_by_paper.csv', check.names = FALSE)
...
include_graphics("../papers/analysis/GPT-4_base_embed/figure/by_question.png")
```

## Figure by paper

```{r figure-by-paper, out.width = '200%'}
include_graphics("../papers/analysis/GPT-4_base_embed/figure/by_paper.png")
```
